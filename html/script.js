...
$(document).on('click', '.Expert-Register-ImageStyle', function(e){
    ...
    if (genders == "male") {
        ...
        $('#Expert-male').attr('src', 'https://cdn.discordapp.com/attachments/877595408325574656/878350193475588146/male2.png');
        $('#Expert-female').attr('src', 'https://cdn.discordapp.com/attachments/877595408325574656/878254563063369818/female.png');
    } else {
        if (genders == "female") {
            SelectedCharGender = "Female"
            $('#Expert-female').attr('src', 'https://cdn.discordapp.com/attachments/877595408325574656/878350146792984616/female2.png');
            $('#Expert-male').attr('src', 'https://cdn.discordapp.com/attachments/877595408325574656/878254579622502471/male.png');
        }
    }
});
